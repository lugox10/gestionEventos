...
public class EventoServiceImpl {
    ...
    @Autowired
    public EventoServiceImpl (EventoRepositorio eventoRepository, EventoMapper eventoMapper, DescripEventoServicio descripEventoServicio, EventoServicio eventoServicio) {
   ...
   //     return eventoRepository.findAll ().stream ().map (eventoMapper :: toDomain).collect (Collectors.toList ());
   // }
//
//
...
//
  ...
  //  public List<Object> obtenerEventosPorTipo (TipoEvento tipoEvento) {
   //     return eventoRepository.findAllByTipoEvento (tipoEvento).stream ().map (eventoMapper :: toDomain).collect (Collectors.toList ());
  //  }
